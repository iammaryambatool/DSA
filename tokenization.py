...
print("Enter Keyword: ")
hashtag = input()
sql_insert_query = "SELECT sentiment_lable,pos_percentage,neg_percentage FROM keywords WHERE keyword_name LIKE %s"
...
for i in range(len(my_list)):
    ...
    print(score)
    print(revscore)
    sql_insert_query = " INSERT INTO `tweets`(`k_id`,`avg_score`, `original_score`, `reversed_score`) VALUES (%s,%s,%s,%s)"
    insert_tuple = (keyword_id,score, score, revscore)
    cur.execute(sql_insert_query, insert_tuple)
    con.commit()
    originaltext=''
